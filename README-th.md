...
- โปรเจกต์จัดโครงสร้างเป็น **4 ฝ่าย**: **ก** ผู้ค้นคว้า (รวบรวมแบบ + ข้อมูล) · **ข** ผู้ประสานงาน (เสนอแบบต่อเจ้าของ) · **ค** เจ้าของ / วิศวกรผู้ได้รับใบอนุญาต / ผู้ตรวจ (ทบทวน รับรอง อนุมัติ จ้างช่าง) · **ง** ช่างก่อสร้าง (สร้างตามแบบที่อนุมัติ)
- วิศวกรผู้ได้รับใบอนุญาต (**ฝ่าย ค**) ต้องทบทวน คำนวณ รับรอง และตรวจหน้างาน — รอยเชื่อม ฐานราก สลัก — **ก่อนเปิดใช้งาน โดยเฉพาะก่อนให้เด็กใช้**
...
| [เครื่องมือกะวัสดุขั้นต่ำ](final1-th/spec.minimum.md) | เครื่องมือคัดวัสดุร้านที่เล็กเกิน — *มิใช่สเปกก่อสร้าง* |
