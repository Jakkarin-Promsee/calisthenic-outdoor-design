...
> 👥 **บริบทเรื่องคน/ความรับผิด — อ่านก่อนถ้าเจองาน policy / quotation / เอกสารส่งมอบ:** [final1/ai/my-situation.md](final1/ai/my-situation.md) — สรุปสถานการณ์ 4 ฝ่าย + กติกาการเขียนเอกสาร (เช่น ⛔ ห้ามใส่คำว่า "AI" ในสัญญา · ใช้คำว่า "แนะนำ" ไม่ใช่ "ต้อง")
...
| `archive/specs/spec.human.v3.md` | **base spec** (ที่มาของ `final1/spec.full.md`) — ใช้ `final1/` เป็นหลัก · ✅ Bar_Straight=42mm sync · wave path verified |
...
├── final1/                            ← ★★ SOURCE OF TRUTH (ชุดเอกสารส่งมอบ formal ไทย) — เริ่มที่ toc.md
...
│   ├── README.md
│   ├── specs/                          ← สเปก/ใบราคา ก่อนรวมเป็น final1/ (spec.human v1–v3 · quotation* · research · severe · *.explore.13062026)
